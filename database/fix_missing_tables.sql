-- Arreglar tablas y vistas faltantes
...
(
    '1234567890', 'CC', 'Juan Carlos', 'Pérez', 'Empresa XYZ', '3001234567', 'juan@empresa.com',
    'Reunión con coordinación', 'Coordinador Académico', 'Coordinación',
    DATE_SUB(NOW(), INTERVAL 1 HOUR), 2, 'DENTRO'
),
(
    '9876543210', 'CE', 'María Fernanda', 'López', 'Proveedor ABC', '3009876543', 'maria@proveedor.com',
    'Entrega de materiales', 'Almacén General', 'Almacén',
    DATE_SUB(NOW(), INTERVAL 3 HOUR), 2, 'SALIO'
);

-- Actualizar la segunda entrada con salida
UPDATE registros_acceso_externo 
SET fecha_salida = DATE_SUB(NOW(), INTERVAL 1 HOUR),
    tiempo_permanencia = 120,
    vigilante_salida_id = 2,
    estado = 'SALIO'
WHERE documento = '9876543210';
